...
import { ResourceCollection } from "@/lib/utils";
...
const props = defineProps<{
    classes: ResourceCollection<Classes>;
    student: Student;
}>();
...
watch(
    ...
    (classId) => {
        ...
        getSections(String(classId));
    }
);

onMounted(() => {
    if (form.class_id) {
        getSections(String(form.class_id));
    }
});

function getSections(classId: string) {
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
                <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-12">
                    <form @submit.prevent="form.put(route('students.update', { student: props.student.id }))">
